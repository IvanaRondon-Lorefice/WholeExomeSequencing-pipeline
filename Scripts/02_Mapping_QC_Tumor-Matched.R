...
samples <- c(strsplit(Sys.getenv("NORMAL_MATCH_SAMPLES"), ",")[[1]], strsplit(Sys.getenv("TUMOR_MATCH_SAMPLES"), ",")[[1]])
...
ggplot(df, aes(x = reorder(Samples, -value), y =value, fill = Samples))+
  ...
  ylab("Primary read (%)")+
  xlab("Samples")
ggsave( paste0(mapping_qc_dir,"Primary_read_",cond,".pdf"), height = 4.5, width = 5)
...
ggplot(df, aes(x = reorder(Samples, -value), y =value, fill = Samples))+
  ...
  ylab("Secondary read (%)")+
  xlab("Samples")
ggsave( paste0(mapping_qc_dir,"Secondary_read_",cond,".pdf"), height = 4.5, width = 5)
...
ggplot(df, aes(x = reorder(Samples, -value), y =value, fill = Samples))+
  ...
  ylab("Supplementary (%)")+
  xlab("Samples")
ggsave( paste0(mapping_qc_dir,"Supplementary_percentage_",cond,".pdf"), height = 4.5, width = 5)
...
ggplot(df, aes(x = reorder(Samples, -value), y =value, fill = Samples))+
  ...
  ylab("Supplementary")+
  xlab("Samples")
ggsave( paste0(mapping_qc_dir,"Supplementary_",cond,".pdf"), height = 4.5, width = 5)
...
ggplot(df, aes(x = reorder(Samples, -value), y =value, fill = Samples))+
  ...
  ylab("Mapped read (%)")+
  xlab("Samples")
ggsave( paste0(mapping_qc_dir,"Mapped_reads_",cond,".pdf"), height = 4.5, width = 5)
...
ggplot(df, aes(x = reorder(Samples, -value), y =value, fill = Samples))+
  ...
  xlab("Samples")
ggsave( paste0(mapping_qc_dir,"Primary_mapped_reads_",cond,".pdf"), height = 4.5, width = 5)
...
ggplot(df, aes(x = reorder(Samples, -value), y =value, fill = Samples))+
  ...
  ylab("Duplicates (%)")+
  xlab("Samples")
ggsave( paste0(mapping_qc_dir,"Duplicates_",cond,".pdf"), height = 4.5, width = 5)
